        ...
        <div class="container">
            <form action="{{ route('movies.update', ['movie' => $movie->id]) }}" method="POST">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col">
                        <textarea name="description" id="description" type="text" cols="30" rows="10">{{$movie->description}}</textarea>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col">
                    ...
                    <div class="col">
                        <input type="text" name="thumb" id="thumb" value="{{$movie->thumb}}">
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col">
                    ...
                    <div class="col">
                        <input type="number" name="price" id="price" step="0.01" value="{{$movie->price}}">
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col">
                    ...
                    <div class="col">
                        <input type="text" name="series" id="series" value="{{$movie->series}}">
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col">
                        <input type="date" name="sale_date" id="sale_date" value="{{$movie->sale_date}}">
                    </div>
                </div>
                <div class="row mt-5">
